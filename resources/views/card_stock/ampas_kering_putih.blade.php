        ...
        <div class="container">
            ...
            <div class="table-container">
                <table>
                    ...
                    <tbody>
                        @foreach ($stokampaskeringputihs as $stokampaskeringputih)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ \Carbon\Carbon::parse($stokampaskeringputih->tanggal)->translatedFormat('d F Y') }}</td>
                                <td>{{ $stokampaskeringputih->keterangan }}</td>
                                <td>{{ $stokampaskeringputih->begin }}</td>
                                <td>{{ $stokampaskeringputih->in_fine }}</td>
                                <td>{{ $stokampaskeringputih->in_medium }}</td>
                                <td>{{ $stokampaskeringputih->out }}</td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('card_stock.ampas_kering_putih.destroy', $stokampaskeringputih->id) }}" method="POST"
                                        ...
                                        <button type="submit" class="delete"
                                            data-id="{{ $stokampaskeringputih->id }}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div id="modal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="stokForm" action="{{ route('card_stock.ampas_kering_putih.store') }}" method="POST" enctype="multipart/form-data" id="stokForm">
                        ...
                        <!-- Kategori Fine/Medium -->
                        <div class="form-group" id="kategoriWrapper" style="display: none;">

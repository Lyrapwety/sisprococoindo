...
@section('content')
    ...
    <div class="mainbar">
        <div class="container">
            <div class="header">
                <h2>Card Stock Ampas Kering Yellow</h2>
            </div>
                    ...
                    <tbody>
                        @foreach ($stokampaskeringyellows as $stokampaskeringyellow)
                            <tr>
                                ...
                                <td>{{ $stokampaskeringyellow->in_medium }}</td>
                                <td>{{ $stokampaskeringyellow->out }}</td>
                                <td>{{ $stokampaskeringyellow->remain }}</td>
                                <td>
                                    <button class="edit" data-id="{{ $stokampaskeringyellow->id }}">Edit</button>
                                    <form action="{{ route('card_stock.ampar_kering_yellow.destroy', $stokampaskeringyellow->id) }}" method="POST"
                                        style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="delete"
                                            data-id="{{ $stokampaskeringyellow->id }}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach

...
@section('content')
    ...
    <div class="mainbar">
        <div class="container">
            <div class="header">
                <h2>Card Stock Minyak Kelapa</h2>
            </div>
                    ...
                    <tbody>
                        @foreach ($stokminyakkelapas as $stokminyakkelapa)
                            <tr>
                                ...
                                <td>{{ $stokminyakkelapa->keterangan }}</td>
                                <td>{{ $stokminyakkelapa->begin }}</td>
                                <td>{{ $stokminyakkelapa->in }}</td>
                                <td>{{ $stokminyakkelapa->out }}</td>
                                <td>{{ $stokminyakkelapa->remain }}</td>
                                <td>
                                    <button class="edit" data-id="{{ $stokminyakkelapa->id }}">Edit</button>
                                    <form action="{{ route('card_stock.minyak_kelapa.destroy', $stokminyakkelapa->id) }}" method="POST"
                                        style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="delete"
                                            data-id="{{ $stokminyakkelapa->id }}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach

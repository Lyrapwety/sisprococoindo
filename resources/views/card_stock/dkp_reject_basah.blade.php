                    ...
                    <tbody>
                        @foreach ($stokrejectbasahs as $stokrejectbasah)
                            <tr>
                                ...
                                <td>{{ $stokrejectbasah->out }}</td>
                                <td>{{ $stokrejectbasah->remain }}</td>
                                <td>
                                    <button class="edit" data-id="{{ $stokrejectbasah->id }}">Edit</button>
                                    <form action="{{ route('card_stock.dkp_reject_basah.destroy', $stokrejectbasah->id) }}" method="POST"
                                        style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="delete"
                                            data-id="{{ $stokrejectbasah->id }}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach

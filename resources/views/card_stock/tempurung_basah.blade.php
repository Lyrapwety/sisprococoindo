...
@section('content')
    ...
    <div class="mainbar">
        <div class="container">
            <div class="header">
                <h2>Card Stock Tempurung Basah</h2>
            </div>
                        ...
                        @foreach ($stoktempurungs as $stoktempurung)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('card_stock.tempurung_basah.destroy', $stoktempurung->id) }}" method="POST"
                                        style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="delete"
                                            data-id="{{ $stoktempurung->id }}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
                ...
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    document.querySelectorAll('.edit').forEach(button => {
                        button.addEventListener('click', function() {
                            ...
                            fetch(`/card_stock/tempurung_basah/${id}/edit`)

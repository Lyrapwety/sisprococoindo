                    ...
                    <tbody>
                        @foreach ($stokrejectkerings as $stokrejectkering)
                            <tr>
                                ...
                                <td>{{ $stokrejectkering->out }}</td>
                                <td>{{ $stokrejectkering->remain }}</td>
                                <td>
                                    <button class="edit" data-id="{{ $stokrejectkering->id }}">Edit</button>
                                    <form action="{{ route('card_stock.dkp_reject_kering.destroy', $stokrejectkering->id) }}" method="POST"
                                        style="display: inline;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="delete"
                                            data-id="{{ $stokrejectkering->id }}">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach

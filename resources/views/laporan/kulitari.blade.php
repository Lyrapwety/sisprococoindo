...
@section('content')
    <style>
        ...
        .form-item .label {
            width: 120px;
            /* Adjust this width as necessary to align labels */
            font-weight: bold;
        }
                    ...
                    <tbody>
                        @foreach ($laporankulitaris as $laporankulitari)
                            <tr>
                                ...
                                <td>{{ $laporankulitari->hasil_kerja }}</td>
                                <td><button id="openFormBtn2" data-id="{{ $laporankulitari->id }}">Hasil Timbangan</button></td>
                                <td>
            ...
            <div id="modal" class="modal">
                <div class="modal-content">
                    <div id="modal-back" class="modal-back">
                        ...
                        <form action="{{ route('laporan.kulitari.store') }}" method="POST"
